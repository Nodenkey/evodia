...
const Loader = ({width, height}) => {
    useEffect(() => {
        ...
        const ellipse1 = document.querySelector('#first-circle');
        const ellipse2 = document.querySelector('#second-circle');
        const ellipse3 = document.querySelector('#third-circle');
